...
// Flagship Background Animation Component
  ...
  useEffect(() => {
    ...
    const animate = () => {
      ...
      particles.forEach((p, i) => {
        ...
        const glowGradient = ctx.createRadialGradient(p.x, p.y, 0, p.x, p.y, currentSize * 3);
    ...
    <main dir="rtl" className="bg-white dark:bg-neutral-950">
        ...
        <div className="relative z-10 container mx-auto px-6 text-white text-right">
          <FadeUp>
            ...
            <p className="mt-6 max-w-xl text-lg opacity-90">
              لايتجيت منصة ثقافية عالمية فريدة.
            </p>
          </FadeUp>
        </div>
      </section>
      ...
      <section className="relative py-28 bg-white dark:bg-neutral-900 overflow-hidden">
        <div className="relative z-10 container mx-auto px-6 text-center max-w-4xl">
          <FadeUp>
            <p className="text-2xl md:text-3xl font-light text-right">
              لايتجيت ليست مجرد منظم فعاليات، إنها ظاهرة عالمية ستعيد تعريف الترفيه.
              <span className="text-orange-500"> نحن نبني تجربة احتفالية فريدة</span>
            </p>

            <p className="mt-10 text-xl text-gray-600 dark:text-gray-400 text-right">
              تجمع بين التكنولوجيا الرائدة والحجم غير المسبوق ومفاهيم احتفالية مبتكرة.
            </p>
          </FadeUp>
        </div>
      </section>
      ...
      <section className="relative py-32 bg-white dark:bg-neutral-900 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-6">
          <FadeUp>
            <div className="text-center mb-20">
              ...
              <p className="mt-4 text-gray-600 dark:text-gray-400 max-w-2xl mx-auto">
                نهج منظم يضمن تنفيذ كل مشروع بدقة وإبداع وتميز من البداية إلى النهاية.
              </p>
            </div>
          </FadeUp>
          ...
          <div className="grid md:grid-cols-4 gap-8 mb-32">
            {[
              { step: "01", title: "الإحاطة والتخطيط", description: "التقاط الأهداف وتصميم لوحة الرؤية", image: "/process-briefing.jpg" },
              { step: "02", title: "التنفيذ", description: "تحويل التصميم إلى واقع مع التعاون", image: "/process-execution.jpg" },
              { step: "03", title: "التحسين النهائي", description: "مراجعات دقيقة وتعديلات أخيرة", image: "/process-finalization.jpg" },
              { step: "04", title: "التسليم", description: "تسليم المشروع مع فحص نهائي", image: "/process-delivery.jpg" },
            ].map((item, index) => (
              <FadeUp key={item.title}>
                <div className="relative group h-full">
                  ...
                  <div className="relative bg-white dark:bg-neutral-800 rounded-xl p-8 border border-gray-200 dark:border-neutral-700 group-hover:border-orange-500/50 group-hover:shadow-[0_0_30px_rgba(255,115,0,0.15)] transition-all duration-500 h-full flex flex-col text-right">
                    ...
                    <p className="text-gray-600 dark:text-gray-400 text-center flex-grow">{item.description}</p>
                  </div>
                </div>
              </FadeUp>
            ))}
        ...
        <div className="relative z-10 container mx-auto px-6 text-white text-right">
          <FadeUp>
            <div className="text-center mb-20">
              ...
              <p className="mt-4 max-w-2xl mx-auto text-gray-300">
                حلول شاملة لإنشاء تجارب ثقافية لا تُنسى بدقة وابتكار.
              </p>
            </div>
          </FadeUp>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-10 mb-16">
            {[
              "إنتاج الفعاليات",
              "التوجيه الإبداعي",
              "تصميم المسرح والمجموعات",
              "الإعلام والبث",
              "التسويق التجريبي",
              "العمليات الفنية",
            ].map((service) => (
              <FadeUp key={service}>
                <div className="p-10 rounded-xl bg-white/5 backdrop-blur border border-orange-500/30 hover:border-orange-500/70 hover:shadow-[0_0_30px_rgba(255,115,0,0.3)] transition-all duration-500 relative group text-right">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="w-10 h-1 bg-orange-500 mb-6 mr-auto group-hover:w-16 group-hover:bg-orange-400 transition-all duration-500" />
                    <p className="text-gray-300 group-hover:text-gray-200 transition-colors">
                      تنفيذ عالي التأثير مصمم للحجم والدقة والتجارب التي لا تُنسى.
                    </p>
                  </div>
                </div>
              </FadeUp>
